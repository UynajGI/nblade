...
class AlgebraConfig:
    ...
    def volume_element_squared(self) -> float | None: ...
    def volume_element_inverse(self) -> MultiVector | None: ...
...
class MultiVector:
    ...
    @classmethod
    def from_numpy(
        cls, config: AlgebraConfig, array: object
    ) -> MultiVector: ...
    ...
    def __mul__(self, other: object) -> MultiVector: ...
