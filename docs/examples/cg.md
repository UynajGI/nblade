...
反射是最基本的几何变换
公式: v' = -n·v·n (其中 n 是单位法向量)

【向量反射】
原始向量 v = 1.000000e1 + 2.000000e2 + 3.000000e3
反射面法向量 n = 1.000000e1 (yz 平面)
...
A: 四元数是几何代数的偶子代数。转子是更一般的概念，可以表示任意维度的旋转。在 3D 中，两者等价。
